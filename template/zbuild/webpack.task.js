...
gulp.task("detectPort",function(cb){
...
gulp.task("webpack",["detectPort"],function(cb){
    ...
    if(program.dev){
        config=ConfigFactory.getDevConfig();
    }else{
...
function addMiddleware(devServer) {
    ...
    var proxy = require(program.resolveApp('package.json')).proxy;
...
gulp.task("webpackDevServer",["webpack"],function(cb){
    ...
    compiler.plugin('done', function (stats) {
        ...
        if (showInstructions) {
            ...
            console.log();
            console.log('  ' + chalk.cyan(protocol + '://' + host + ':' + DEFAULT_PORT + '/'));
            console.log();
